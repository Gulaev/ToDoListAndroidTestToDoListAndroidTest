...
public class MobileTesting extends AbstractTest implements IMobileUtils {
  ...
  public void verifyAddNewTaskTest() {
    ...
    Assert.assertEquals(currentNumberOfTask, numberOfTaskBeforeTest + 1,
  ...
  public void verifyAddNewTaskToDifferentCategoryTest() {
    ...
    homePage.addNewTask("New task");
    homePage.hideKeyboard();
    Assert.assertEquals(numberOfTasksBefore +1, homePage.getNumberOfTasks(),
  ...
  public void verifyAddNewCategoryTest() {
    ...
    Assert.assertEquals(numberOfCategoryBefore +1, manageCategoriesPage.numberOfCategories(),
  ...
  public void verifyDoneTask() {
    ...
    Assert.assertEquals(numberOfCompletedTaskBefore +1, currentNumberCompletedTask,
